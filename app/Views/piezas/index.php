...
window.addEventListener('load', function () {
    var h = location.hash;
    if (h === '#organizar') {
        var b = document.getElementById('btnOrganizar');
        if (b) b.click();
    } else if (/^#modal\w+$/.test(h) && document.querySelector(h)) {
        bootstrap.Modal.getOrCreateInstance(document.querySelector(h)).show();
    }
