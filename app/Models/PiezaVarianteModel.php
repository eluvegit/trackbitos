...
class PiezaVarianteModel extends Model
{
    ...
    protected $allowedFields = ['familia_id', 'nombre', 'sku', 'stock_minimo', 'hueco_predeterminado_id', 'origen_version_id', 'notas', 'advertencia', 'tareas', 'enlace_original', 'borrado_en', 'visible_sterclicks'];
